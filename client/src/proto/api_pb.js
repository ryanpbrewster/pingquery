...
goog.exportSymbol('proto.pingquery.api.Path', null, global);
 ...
 * @constructor
 */
proto.pingquery.api.Path = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pingquery.api.Path.repeatedFields_, null);
};
goog.inherits(proto.pingquery.api.Path, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pingquery.api.Path.displayName = 'proto.pingquery.api.Path';
}
...
proto.pingquery.api.QueryConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    listenList: jspb.Message.toObjectList(msg.getListenList(),
    proto.pingquery.api.Path.toObject, includeInstance)
  };
...
proto.pingquery.api.QueryConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.pingquery.api.Path;
      reader.readMessage(value,proto.pingquery.api.Path.deserializeBinaryFromReader);
      msg.addListen(value);
      break;
    default:
      reader.skipField();
...
proto.pingquery.api.QueryConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.pingquery.api.Path.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.pingquery.api.Path>}
 */
proto.pingquery.api.QueryConfig.prototype.getListenList = function() {
  return /** @type{!Array<!proto.pingquery.api.Path>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pingquery.api.Path, 3));
};


/**
 * @param {!Array<!proto.pingquery.api.Path>} value
 * @return {!proto.pingquery.api.QueryConfig} returns this
*/
...
/**
 * @param {!proto.pingquery.api.Path=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pingquery.api.Path}
 */
proto.pingquery.api.QueryConfig.prototype.addListen = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.pingquery.api.Path, opt_index);
};
...
proto.pingquery.api.MutateConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    sqlTemplate: jspb.Message.getFieldWithDefault(msg, 2, ""),
    notifyList: jspb.Message.toObjectList(msg.getNotifyList(),
    proto.pingquery.api.Path.toObject, includeInstance)
  };
 ...
 * @return {!proto.pingquery.api.Path}
 */
proto.pingquery.api.MutateConfig.prototype.addNotify = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.pingquery.api.Path, opt_index);
};
 ...
 * @const
 */
proto.pingquery.api.Path.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pingquery.api.Path.prototype.toObject = function(opt_includeInstance) {
  return proto.pingquery.api.Path.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pingquery.api.Path} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pingquery.api.Path.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.pingquery.api.Path}
 */
proto.pingquery.api.Path.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pingquery.api.Path;
  return proto.pingquery.api.Path.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pingquery.api.Path} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pingquery.api.Path}
 */
proto.pingquery.api.Path.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pingquery.api.Path.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pingquery.api.Path.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pingquery.api.Path} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pingquery.api.Path.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.pingquery.api.Path.prototype.getSegmentsList = function() {
 ...
 * @return {!proto.pingquery.api.Path} returns this
 */
proto.pingquery.api.Path.prototype.setSegmentsList = function(value) {
 ...
 * @return {!proto.pingquery.api.Path} returns this
 */
proto.pingquery.api.Path.prototype.addSegments = function(value, opt_index) {
 ...
 * @return {!proto.pingquery.api.Path} returns this
 */
proto.pingquery.api.Path.prototype.clearSegmentsList = function() {
